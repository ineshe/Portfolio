    ...
    <div class="content">
        ...
        <div class="project-cards">
            <section class="project">
                <a href="<?php echo $baseURL?>/../src/views/project-detail/project-detail.php?id=5">
            ...
            <section class="project">
                <a href="<?php echo $baseURL?>/../src/views/project-detail/project-detail.php?id=1">
            ...
            <section class="project">
                <a href="<?php echo $baseURL?>/../src/views/project-detail/project-detail.php?id=2">
            ...
            <section class="project">
                <a href="<?php echo $baseURL?>/../src/views/project-detail/project-detail.php?id=3">
            ...
            <section class="project">
                <a href="<?php echo $baseURL?>/../src/views/project-detail/project-detail.php?id=4">
